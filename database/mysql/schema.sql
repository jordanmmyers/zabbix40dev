...
CREATE TABLE `host_inventory` (
	...
	`os_full`                varchar(96)     DEFAULT ''                NOT NULL,
	`os_short`               varchar(32)     DEFAULT ''                NOT NULL,
	`serialno_a`             varchar(64)     DEFAULT ''                NOT NULL,
	`serialno_b`             varchar(64)     DEFAULT ''                NOT NULL,
	`tag`                    varchar(64)     DEFAULT ''                NOT NULL,
	`asset_tag`              varchar(64)     DEFAULT ''                NOT NULL,
	`macaddress_a`           varchar(18)     DEFAULT ''                NOT NULL,
	`macaddress_b`           varchar(18)     DEFAULT ''                NOT NULL,
	`hardware`               varchar(64)     DEFAULT ''                NOT NULL,
	`hardware_full`          text                                      NOT NULL,
	`software`               varchar(64)     DEFAULT ''                NOT NULL,
	...
	`deployment_status`      varchar(32)     DEFAULT ''                NOT NULL,
	`url_a`                  text                                      NULL,
	`url_b`                  text                                      NULL,
	`url_c`                  text                                      NULL,
	...
	`date_hw_purchase`       varchar(32)     DEFAULT ''                NOT NULL,
	`date_hw_install`        varchar(32)     DEFAULT ''                NOT NULL,
	`date_hw_expiry`         varchar(32)     DEFAULT ''                NOT NULL,
	`date_hw_decomm`         varchar(32)     DEFAULT ''                NOT NULL,
	...
	`site_state`             varchar(32)     DEFAULT ''                NOT NULL,
	`site_country`           varchar(32)     DEFAULT ''                NOT NULL,
	`site_zip`               varchar(16)     DEFAULT ''                NOT NULL,
	`site_rack`              varchar(64)     DEFAULT ''                NOT NULL,
	`site_notes`             text                                      NOT NULL,
	`poc_1_name`             varchar(64)     DEFAULT ''                NOT NULL,
	`poc_1_email`            varchar(96)     DEFAULT ''                NOT NULL,
	`poc_1_phone_a`          varchar(32)     DEFAULT ''                NOT NULL,
	`poc_1_phone_b`          varchar(32)     DEFAULT ''                NOT NULL,
	`poc_1_cell`             varchar(32)     DEFAULT ''                NOT NULL,
	`poc_1_screen`           varchar(32)     DEFAULT ''                NOT NULL,
	`poc_1_notes`            text                                      NOT NULL,
	`poc_2_name`             varchar(64)     DEFAULT ''                NOT NULL,
	`poc_2_email`            varchar(96)     DEFAULT ''                NOT NULL,
	`poc_2_phone_a`          varchar(32)     DEFAULT ''                NOT NULL,
	`poc_2_phone_b`          varchar(32)     DEFAULT ''                NOT NULL,
	`poc_2_cell`             varchar(32)     DEFAULT ''                NOT NULL,
	`poc_2_screen`           varchar(32)     DEFAULT ''                NOT NULL,
...
ALTER TABLE `tag_filter` ADD CONSTRAINT `c_tag_filter_2` FOREIGN KEY (`groupid`) REFERENCES `groups` (`groupid`) ON DELETE CASCADE;
